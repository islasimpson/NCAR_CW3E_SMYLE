...
def plothisto(fig, dat, bins, x1=0, x2=1, y1=0, y2=1, percent=False, xlim=None, ylim=None,
     yticks=None, yticklabels=None, ytitle=None, xticklabels=None, xtitle=None, color='lightgray', label=None, addlines=False, title=None, orient='horizontal', alpha=1):
    """ Plot a histogram 
    ...
    if (orient == 'horizontal' ):
        ...
        ax.bar(0, binedges[1:np.size(binedges)] - binedges[0:np.size(binedges)-1], width=histo,
               bottom = binedges[0:np.size(binedges)-1], edgecolor='black', color=color, label=label, 
